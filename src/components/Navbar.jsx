...
const Navbar = () => {
    ...
    const navLinks = (
        <>
            ...
            <NavLink to="/blogs" className={({ isActive }) => isActive ? "text-[#3c3cf6] font-bold" : "text-[#181111] hover:text-[#3c3cf6] font-medium"}>
                Blogs
            </NavLink>

            {user && (
                <NavLink to="/profile" className={({ isActive }) => isActive ? "text-[#3c3cf6] font-bold" : "text-[#181111] hover:text-[#3c3cf6] font-medium"}>
                    My Profile
                </NavLink>
            )}
        </>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-white border-t border-gray-100 absolute w-full left-0 top-20 shadow-xl py-4 px-4 flex flex-col gap-4">
                    ...
                    {user && (
                        <button 
                            onClick={handleLogout}
                            className="w-full h-10 bg-[#ef4343]/10 text-[#ef4343] font-bold rounded-lg mt-2"
                        >
                            Logout
                        </button>
                    )}
